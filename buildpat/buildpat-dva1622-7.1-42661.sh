curl -L https://global.download.synology.com/download/DSM/release/7.1/42661/DSM_DVA1622_42661.pat -o ds.pat
mkdir synoesp
curl --location https://global.download.synology.com/download/DSM/release/7.0.1/42218/DSM_DVA3221_42218.pat --output oldpat.tar.gz
...
mv archive.tar.gz ../dva1622_42661.pat
cd ../
